								...
								<div class="product">
										...
										<div class="images">
											<div class="product-simple-image">
												<a href="<c:url value="/resources/images/"/>product/product_405x515.jpg" data-rel="prettyPhoto">
													<img width="300" height="381" src="<c:url value="/resources/images/"/>product/product_405x515.jpg" alt="" />
												</a>
											</div>
										</div>
										<div class="summary entry-summary">
											<h1 class="product_title entry-title">Cucumbers</h1>
											<p class="price"><span class="amount">&#36;1.95</span></p>
									...
									<div class="commerce-tabs">
										<ul class="nav nav-tabs tabs">
									    	...
									    	<li>
									    		<a data-toggle="tab" href="#tab-3">Profile</a>
									    	</li>
									  	</ul>
