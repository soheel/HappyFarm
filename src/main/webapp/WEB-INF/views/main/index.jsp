...
<div class="main">
	...
	<div class="testimonial">
		<div class="noo_testimonial_wrap">
			<img width="328" height="851"
				src="<c:url value="/resources/img/main/"/>image_left.png"
				class="image_left" alt="" /> <img width="329" height="789"
				src="<c:url value="/resources/img/main/"/>image_right.png"
				class="image_right" alt="" />
				...
				<div class="item">
					<div class="testimonial-content">
						...
						<div>
							...
							<p>Maecenas tristique gravida odio, et sagi ttis justo
								interdum porta. Duis et lacus mattis, tincidunt ero. Donec
								dictum non nulla ut tris tique gravida odio lobortis tristique
								gravida. Aliquam erat volutpat. Pellentesque auctor, arcu id
								tristique.</p>
			...
			<div class="noo-testimonial-sync1 testimonial-three">
				<div class="item">
					<div class="background_image">
						<img class="noo_testimonial_avatar"
							src="<c:url value="/resources/images/"/>avatar/avatar_120x120.jpg"
							alt="" />
					</div>
