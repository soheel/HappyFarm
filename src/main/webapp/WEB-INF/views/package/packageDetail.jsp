								...
								<div class="images">
									<div class="project-slider">
										<div class="owl-carousel sync1">
											...
											<div class="item">
												<a href="<c:url value="/resources/images/"/>box/box_540x686.jpg" data-rel="prettyPhoto[product-gallery]">
													<img width="300" height="381" src="<c:url value="/resources/images/"/>box/box_540x686.jpg" alt="" /> 
												</a>
											</div>
											<div class="item">
												<a href="<c:url value="/resources/images/"/>box/box_540x686.jpg" data-rel="prettyPhoto[product-gallery]">
											...
											<div class="item">
												<a href="<c:url value="/resources/images/"/>box/box_540x686.jpg" data-rel="prettyPhoto[product-gallery]">
													<img width="260" height="330" src="<c:url value="/resources/images/"/>box/box_540x686.jpg" alt="" /> 
												</a>
											</div>
											<div class="item">
												<a href="<c:url value="/resources/images/"/>box/box_540x686.jpg" data-rel="prettyPhoto[product-gallery]">
						...
						<div class="product">
							<div class="commerce-tabs">
										<ul class="nav nav-tabs tabs">
									    	...
									    	<li>
									    		<a data-toggle="tab" href="#tab-review">Reviews</a>
									    	</li>
									  	</ul>
